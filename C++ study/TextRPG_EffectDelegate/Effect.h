...
// ==========================================
// DelegateEffectManager (함수 포인터 / 델리게이트 기반 효과 관리자)
// ==========================================
// 델리게이트 시그니처 정의 (함수 포인터 대신 std::function 활용)
using EffectDelegate = std::function<void(CPlayer*, CPlayer*, int)>;
...
public:
    ...
    void RegisterDelegate(int id, const std::string& name, int value, EffectDelegate func);
};